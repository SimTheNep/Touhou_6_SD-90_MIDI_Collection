...
* **SysEx Integration:** Native parameter configurations variables were injected directly using the hexadecimal code exported from the [Edirol SD-80 Editor](https://www.cosmosmusic.com/support/download_read.php?no=9772) and [Edirol SD-90 Editor](https://github.com/SimTheNep/Touhou_6_SD-90_MIDI_Collection/blob/main/SD90Editor.EXE).
* **Audio Mastering & Demos:**Demo audio captures from the SD-90 outputs were compiled and mastered using [**Sonic Foundry Sound Forge 6.0**](https://www.soundonsound.com/reviews/sonic-foundry-sound-forge-6), the exact audio editing software used by ZUN for rendering the original game soundtracks.
